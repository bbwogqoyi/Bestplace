...
<template>
  <section class="space-y-8">
    <!-- Contact Us Form -->
    <div class="flex border shadow-md bg-white">
          ...
          <form @submit="submitEnquiry" class="m-7 space-y-4">
            ...
            <div class="flex justify-between mb-6">
              <div>
                ...
                <label for="name" class="ml-2 text-sm text-gray-600 ">Agent</label>
              </div>
              <div>
                <input type="checkbox" name="name" id="name" placeholder="John Doe" v-model="newEnquiry.betterBond"/>
                <label for="name" class="ml-2 text-sm text-gray-600 ">Better Bond</label>
              </div>
              <div>
                <input type="checkbox" name="name" id="name" placeholder="John Doe" v-model="newEnquiry.contractor"/>
                <label for="name" class="ml-2 text-sm text-gray-600 ">Contractor</label>
              </div>
            </div>

            <!-- Contact info -->
            <div class="space-y-1" v-if="isAuthenticated">
              <div class="flex justify-between">
                <label for="name" class="text-sm text-gray-600 ">Full Name:</label>
                <span class="text-gray-700 ">{{ `${loggedInUser.firstname} ${loggedInUser.lastname}` }}</span>
              ...
              <div class="flex justify-between">
                ...
                <span class="text-gray-700 ">{{ loggedInUser.email }}</span>
              ...
              <div class="flex justify-between">
                ...
                <span class="text-gray-700 ">{{ loggedInUser.phone || "None" }}</span>
            ...
            <div class="space-y-1">
              <div>
                <label for="message" class="block my-3 text-xl text-center font-semibold text-gray-700">Your Message</label>
                <textarea rows="5" name="message" id="message" placeholder="Your Message" class="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 " v-model="newEnquiry.message" required ></textarea>
              </div>
              <div>
    ...
    <div class="flex border shadow-md bg-white">
      <div class="container mx-auto" v-if="isAuthenticated">
        <div class="max-w-md mx-auto bg-white md:px-5 my-7 rounded-md shadow-sm">
          <div class="text-center border border-gray-400 py-3 my-3">
            <p class="text-5xl font-bold text-gray-700">Bestplace</p>
            <p class="text-base font-semibold whitespace-pre mt-2">The Property Company</p>  
          </div>

          <div class="mt-6 space-y-6">
            <div class="flex justify-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
              <img class="h-60 w-60 rounded-full" src="https://images.unsplash.com/photo-1463453091185-61582044d556?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
            </div>

            <p class="text-center text-gray-600 font-semibold">Nkosinathi Zaba</p>

            <div class="w-full px-3 py-3 rounded-md font-medium text-[#007bfc] border-[#007bfc] bg-gradient-to-r hover:from-[#007bfc] hover:to-[#51b9ff] hover:text-white border focus:outline-none">
              <div class="flex items-center justify-center">
                <svg class="w-6 h-6 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25z"/></svg>

                <p class="font-bold">Show Contact Number</p>
              </div>
            </div>
        ...
        <div class="max-w-md mx-auto bg-white md:px-5 my-7 rounded-md shadow-sm">
          <div class="p-2 flex items-center justify-center">
            <div class="container max-w-screen-lg mx-auto">
              <div>
                <h2 class="text-3xl font-semibold text-center mb-6 text-gray-700">Share</h2>
