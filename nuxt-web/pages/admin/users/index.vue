...
const { data } = await useFetch('http://localhost:5001/accounts')
let users = ref(data)
</script>
          ...
          <div class="w-full flex justify-between my-8 pt-4">
            ...
            <div class="flex w-96">
              ...
              <input
                ...
                type="text" placeholder="Search User Email ..." />
            </div>
          ...
          <div class="">
            <table class="min-w-full divide-y divide-gray-200 table-fixed w-full">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <!-- Draft Row -->
                <tr v-for="user in users" :key="user._key">
                  <td class="py-4 whitespace-nowrap">
                    <div class="flex flex-row justify-between items-center">
                      <div @click="$router.push('/admin/dashboard/view/enquiry/102')"
                        class="flex flex-col w-[85%] overflow-x-hidden">
