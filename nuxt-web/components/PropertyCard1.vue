...
<template>
  <div class="w-full lg:w-4/5 mx-auto my-5">
    <div class="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl md:h-80 mx-2 md:border-2 cursor-pointer" @click="$router.push(`/property/${id}`)">
      <!-- image -->
        ...
        <div class="p-8 md:pr-18 md:pl-14 -md:py-12 mx-2 md:mx-0 h-full bg-white rounded-lg md:rounded-none md:rounded-l-lg shadow-xl md:shadow-none border-2 md:border-0">
          ...
          <div class="flex flex-col">
            <div class="flex space-x-6 py-4 text-gray-700">
              <!-- Bedrooms -->
              <div class="flex items-center" title="Bedrooms" v-if="isNotEmpty(numOfBeds)">
              ...
              <!-- Bathrooms -->
              <div class="flex items-center" title="Bathrooms" v-if="isNotEmpty(numOfBaths)">
                <svg class="h-6 w-6 text-gray-600 fill-current mr-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <div class="flex items-center" title="Parking Spaces" v-if="isNotEmpty(numOfParkingSpaces)">
              ...
              <!-- Eff Area -->
              <div class="flex items-center" title="Erf Size" v-if="isNotEmpty(erfSize)">
