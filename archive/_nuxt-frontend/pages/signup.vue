  ...
  <div class="min-h-screen bg-no-repeat bg-cover bg-center bg-img">
  	<div class="flex justify-end">
          ...
          <div class="my-3">
						...
						<input class="px-4 w-full border-2 py-2 rounded-md text-sm outline-none" type="text" name="firstname" placeholder="Firstname">
          </div>
          <div class="my-3">
						<label class="block text-md mb-2" for="email">Lastname</label>
						<input class="px-4 w-full border-2 py-2 rounded-md text-sm outline-none" type="text" name="lastname" placeholder="Lastname">
          </div>
          <div class="my-3">
          ...
          <div class="mt-2 flex justify-between items-center mx-1">
            ...
            <router-link to="/signin" class="cursor-pointer text-sm text-blue-600">Sign In</router-link>
          </div>
  			</div>
  		</div>
  	</div>
