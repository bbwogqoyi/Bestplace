...
<div class="w-full lg:w-4/5 mx-auto my-5">
  <div class="relative rounded-lg flex flex-col md:flex-row items-center md:shadow-xl drop-shadow-sm md:h-80 mx-2 border border-gray-200">
    <div class="z-0 order-1 md:order-2 relative w-full md:w-2/5 lg:w-1/2 h-80 md:h-full overflow-hidden rounded-lg md:rounded-none md:rounded-r-lg cursor-pointer" @click="$router.push('/property')">
      <div class="absolute inset-0 w-full h-full object-fill object-center bg-blue-400 bg-opacity-30 bg-cover bg-bottom" style="background-image: url( https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxfDB8MXxhbGx8fHx8fHx8fA&ixlib=rb-1.2.1&q=80&w=1080&utm_source=unsplash_source&utm_medium=referral&utm_campaign=api-credit ); background-blend-mode: multiply;">
        <div class="flex justify-end">
          <svg class="h-7 w-7 mt-4 mr-4 text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      ...
      <div class="md:hidden absolute inset-0 h-full p-6 pb-6 flex flex-col-reverse justify-start items-start bg-gradient-to-b from-transparent via-transparent to-gray-900">
        <h3 class="w-full font-bold text-2xl text-white leading-tight mb-2">Olifantsfontein</h3>
        <h4 class="w-full text-xl text-gray-100 leading-tight">Gauteng</h4>
      </div>
    ...
    <!-- Desktop -->
    <div class="z-10 order-2 md:order-1 w-full h-full md:w-3/5 lg:w-1/2 flex items-center -mt-6 md:mt-0 cursor-pointer" @click="$router.push('/property')" >
      <div class="px-6 md:pr-18 md:pl-10 md:py-6 mx-2 md:mx-0 h-full bg-white rounded-lg md:rounded-none md:rounded-l-lg shadow-xl md:shadow-none">
        <div class="flex flex-col space-y-2">
          <div class="hidden md:flex">
            <p class=" text-2xl font-semibold">
              Olifantsfontein
              <span class="text-sm font-normal text-gray-300 ml-2">Gauteng</span>  
            </p>
          </div>
          <!-- Costs -->
          <div>
            <p class="hidden md:block text-sm uppercase font-semibold text-gray-400">Purchase Price</p>
            <p class="hidden md:block font-bold text-2xl text-gray-700">R 670 000</p>
          </div>
          <!-- Icons -->
          <div class="flex flex-col">
            ...
            <p class="text-gray-600 text-justify h-24 overflow-y-hidden overflow-ellipsis">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ratione itaque perspiciatis quod sapiente quidem, vero consectetur quae iure error tempore reprehenderit unde veritatis fugit iusto nemo amet. Assumenda, quam facilis.
            </p>
            <div class="flex space-x-6 py-4 text-gray-700">
              ...
              <div class="flex items-center">
                ...
                <p><span class="text-gray-900 font-bold">3</span></p>
              </div>
              ...
              <div class="flex items-center">
                ...
                <p><span class="text-gray-900 font-bold">2</span></p>
              </div>
