<script setup>
import ContactAgentForm from './ContactAgentForm.vue';
</script>
...
<div class=" bg-gray-50">
  ...
  <div class="w-full lg:w-4/5 mx-auto bg-gray-100 border-2">
    <div class="flex justify-between items-center">
      <div class="hidden md:flex justify-center items-center h-32 w-16 rounded-tr-full rounded-br-full bg-gray-200  hover:bg-gray-400">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
        </svg>
      </div>
      <img class="h-96" src="https://images.unsplash.com/photo-1584738766473-61c083514bf4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxfDB8MXxhbGx8fHx8fHx8fA&ixlib=rb-1.2.1&q=80&w=1080&utm_source=unsplash_source&utm_medium=referral&utm_campaign=api-credit" />
      <div class="hidden md:flex justify-center items-center h-32 w-16 rounded-tl-full rounded-bl-full bg-gray-200 hover:bg-gray-400">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="border shadow-md p-8 bg-white">
          ...
          <div class="space-y-2 mb-4">
            <div>
              ...
              <p class="block font-bold text-2xl text-gray-700">R 670 000</p>
            </div>

            <div>
              <p class="block text-sm uppercase font-semibold text-gray-400">Rehab Price</p>
              <p class="block font-bold text-2xl text-gray-700">R 75 000</p>
            </div>

            <div>
              <p class="block text-sm uppercase font-semibold text-gray-400">Total Investment</p>
              <p class="block font-bold text-2xl text-gray-700">R 745 000</p>
            </div>
            ...
            <table class="table-fixed">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="py-4 px-2">110121287</td>
                </tr>
                <tr class="bg-gray-100">
                  <td class="py-4 px-2">Listing Date</td>
                  <td class="py-4 px-2">22 June 2021</td>
                </tr>
                <tr>
                  <td class="py-4 px-2">Erf Size</td>
                  <td class="py-4 px-2">1 125 m<sup>2</sup></td>
                </tr>
                <tr class="bg-gray-100">
                  <td class="py-4 px-2">Rates and Taxes</td>
                  <td class="py-4 px-2">R 1 486</td>
                </tr>
                <tr>
                  <td class="py-4 px-2">Flatlet</td>
                  <td class="py-4 px-2">Yes</td>
                </tr>
              </tbody>
            </table>
          </div>
