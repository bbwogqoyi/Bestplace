  ...
  <div class="w-full lg:w-4/5 mx-auto pb-10 bg-gray-100">
    ...
    <div class="flex flex-col px-8 py-10 mt-10 shadow overflow-hidden border border-gray-200 bg-white space-y-6">
      ...
      <div class="my-3">
				...
				<input class="px-4 w-full border-2 border-gray-400 py-2 rounded-md text-sm outline-none" type="text"  name="location" placeholder="Sandhurst, Sandton, Gauteng">
      </div>
      <div class="flex space-x-6 ">
        ...
        <div class="w-1/2">
          <div class="text-left w-full my-3">
            ...
            <div class="rounded-md shadow-sm border-2 border-gray-400 rounded-md text-sm outline-none">
